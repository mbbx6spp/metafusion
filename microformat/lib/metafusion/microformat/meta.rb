# meta.rb contains <tt>Metafusion::Microformat::Meta</tt> and related classes that
# help define the metadata of the <tt>metafusion-microformat</tt> project.

require('rubygems')
require('erb')

class Metafusion::Microformat::Meta #:nodoc:
  attr_accessor :root_dir
  attr_reader :gem_spec, :project_files, :spec_files

  # Initializer for Metafusion::Microformat::Meta class.  Takes <tt>root_dir</tt> as parameter.
  ...
  # Returns RubyGem specification for Metafusion::Microformat project
  def gem_spec
