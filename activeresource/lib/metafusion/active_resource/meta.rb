# meta.rb contains <tt>Metafusion::ActiveResource::Meta</tt> and related classes that
# help define the metadata of the <tt>metafusion-activeresource</tt> project.

require('rubygems')
require('erb')

class Metafusion::ActiveResource::Meta #:nodoc:
  attr_accessor :root_dir
  attr_reader :gem_spec, :project_files, :spec_files

  # Initializer for Metafusion::ActiveResource::Meta class.  Takes <tt>root_dir</tt> as parameter.
  ...
  # Returns RubyGem specification for Metafusion::ActiveResource project
  def gem_spec
